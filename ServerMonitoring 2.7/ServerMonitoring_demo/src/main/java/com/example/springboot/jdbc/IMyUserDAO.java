...
public interface IMyUserDAO {
	...
	public void writeDao(String CpuUsage, String MemoryFreespace, String MemoryTotalSpace, int CpuCore,
			int CpuProcessors, String ServerName);
	...
	public int UpdateForm(@Param("serverName") String serverName, @Param("ServerIP") String ServerIP,
			@Param("ServerPort") String ServerPort, @Param("ServerIN") String ServerIN,
			@Param("ServerPw") String ServerPw, @Param("serverName2") String serverName2);

	public List<MyUserDTO> SelectServerName();

	public int DeleteForm(@Param("ServerName") String serverName);

	//public List<MyUserDTO> ServerNameOtherSelect(@Param("ServerName")  String ServerName);


	// public int UserServerInfo(float CpuUsage, float MemoryFreespace, float
